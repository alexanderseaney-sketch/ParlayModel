"""
Mix-and-match round for receiving yards: game context (Vegas implied total, home/away,
weather, rest) + snap share, individually and combined, on top of the existing best
feature set. Same rigorous pooled 5-season CV + confidence-filtered accuracy.
"""
import os
...
def main():
    ...
    print(f"\nSnap share coverage: {df['offense_pct_rolling'].notna().mean()*100:.1f}% of rows have a value")
